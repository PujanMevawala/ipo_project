      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white border-t mt-2">
          <div className="container mx-auto py-4 px-4 space-y-4">
            <a href="#" className="block text-gray-600 hover:text-blue-600 py-2">IPO</a>
            <a href="#" className="block text-gray-600 hover:text-blue-600 py-2">Community</a>
            <a href="#" className="block text-gray-600 hover:text-blue-600 py-2">Products</a>
            <a href="#" className="block text-gray-600 hover:text-blue-600 py-2">
              Brokers <span className="bg-blue-500 text-white text-xs px-2 py-0.5 rounded-full ml-1">NEW</span>
            </a>
            <a href="#" className="block text-gray-600 hover:text-blue-600 py-2">Live News</a>
